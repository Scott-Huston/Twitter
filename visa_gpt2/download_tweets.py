### copied from here https://raw.githubusercontent.com/minimaxir/download-tweets-ai-text-gen/master/download_tweets.py ###
...
def download_tweets(
    ...
    # If no limit specifed, estimate the total number of tweets from profile.
        ...
        # TODO fix bug in original, I hardcoded in a reasonable limit for the user I wanted
        limit = 100000
